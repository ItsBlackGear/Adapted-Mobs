...
import com.cf28.adaptedmobs.core.platform.common.IntegrationRegistry;
...
@Mod.EventBusSubscriber(modid = AdaptedMobs.MOD_ID, bus = Mod.EventBusSubscriber.Bus.FORGE)
