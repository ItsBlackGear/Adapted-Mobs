...
public class SupportSporesItem extends CreeperSporesItem {
    public SupportSporesItem(Properties properties) {
        super(properties);
    }
    ...
    public @NotNull InteractionResultHolder<ItemStack> use(Level level, Player player, @NotNull InteractionHand hand) {
        ...
        if (!level.isClientSide()) {
            level.addFreshEntity(TolerableCreepersIntegration.createSporeItemProjectile(AMSporeBarrelBlock.SporeType.SUPPORT, player, level));
        }
