...
public class AMEntityTypes {
    ...
    public static final Supplier<EntityType<TamableCreeper>> CREEPER = create("creeper", EntityType.Builder.of(TamableCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.8F).clientTrackingRange(8));
