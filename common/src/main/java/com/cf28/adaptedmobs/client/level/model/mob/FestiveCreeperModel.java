...
public class FestiveCreeperModel<T extends FestiveCreeper> extends AgeableHierarchicalModel<T> {
    ...
    public static LayerDefinition createBodyLayer(CubeDeformation deformation) {
        ...
        belly.addOrReplaceChild("belly_r1", ModelUtil.addFringeBox(CubeListBuilder.create().texOffs(0, 16), -2.0F, -5.0F, 0.0F, 2.0F, 10.0F, 0.0F, false), PartPose.offsetAndRotation(-7.0F, -5.0F, -7.0F, 0.0F, -0.7854F, 0.0F));
        belly.addOrReplaceChild("belly_r2", ModelUtil.addFringeBox(CubeListBuilder.create().texOffs(0, 16), 0.0F, -10.0F, 0.0F, 2.0F, 10.0F, 0.0F, true), PartPose.offsetAndRotation(7.0F, 0.0F, 7.0F, 0.0F, -0.7854F, 0.0F));
        belly.addOrReplaceChild("belly_r3", ModelUtil.addFringeBox(CubeListBuilder.create().texOffs(0, 16), 0.0F, -10.0F, 0.0F, 2.0F, 10.0F, 0.0F, true), PartPose.offsetAndRotation(7.0F, 0.0F, -7.0F, 0.0F, 0.7854F, 0.0F));
        belly.addOrReplaceChild("belly_r4", ModelUtil.addFringeBox(CubeListBuilder.create().texOffs(0, 16), -2.0F, -10.0F, 0.0F, 2.0F, 10.0F, 0.0F, false), PartPose.offsetAndRotation(-7.0F, 0.0F, 7.0F, 0.0F, 0.7854F, 0.0F));
        belly.addOrReplaceChild("belly_r5", ModelUtil.addFringeBox(CubeListBuilder.create().texOffs(28, 4), -7.0F, 0.0F, 0.0F, 14.0F, 2.0F, 0.0F, false), PartPose.offsetAndRotation(0.0F, 0.0F, 7.0F, 0.7854F, 0.0F, 0.0F));
        belly.addOrReplaceChild("belly_r6", ModelUtil.addFringeBox(CubeListBuilder.create().texOffs(28, 6), -7.0F, -2.0F, 0.0F, 14.0F, 2.0F, 0.0F, false), PartPose.offsetAndRotation(0.0F, -10.0F, 7.0F, -0.7854F, 0.0F, 0.0F));
        belly.addOrReplaceChild("belly_r7", ModelUtil.addFringeBox(CubeListBuilder.create().texOffs(28, 4), -7.0F, 0.0F, 0.0F, 14.0F, 2.0F, 0.0F, false), PartPose.offsetAndRotation(0.0F, 0.0F, -7.0F, -0.7854F, 0.0F, 0.0F));
        belly.addOrReplaceChild("belly_r8", ModelUtil.addFringeBox(CubeListBuilder.create().texOffs(28, 6), -7.0F, -2.0F, 0.0F, 14.0F, 2.0F, 0.0F, false), PartPose.offsetAndRotation(0.0F, -10.0F, -7.0F, 0.7854F, 0.0F, 0.0F));
        belly.addOrReplaceChild("belly_r9", ModelUtil.addFringeBox(CubeListBuilder.create().texOffs(28, -8), 0.0F, -2.0F, 0.0F, 0.0F, 2.0F, 14.0F, false), PartPose.offsetAndRotation(-7.0F, -10.0F, -7.0F, 0.0F, 0.0F, -0.7854F));
        belly.addOrReplaceChild("belly_r10", ModelUtil.addFringeBox(CubeListBuilder.create().texOffs(28, -10), 0.0F, 0.0F, -7.0F, 0.0F, 2.0F, 14.0F, false), PartPose.offsetAndRotation(-7.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.7854F));
        belly.addOrReplaceChild("belly_r11", ModelUtil.addFringeBox(CubeListBuilder.create().texOffs(28, -10), 0.0F, 0.0F, 0.0F, 0.0F, 2.0F, 14.0F, false), PartPose.offsetAndRotation(7.0F, 0.0F, -7.0F, 0.0F, 0.0F, -0.7854F));
        belly.addOrReplaceChild("belly_r12", ModelUtil.addFringeBox(CubeListBuilder.create().texOffs(28, -8), 0.0F, -2.0F, -7.0F, 0.0F, 2.0F, 14.0F, false), PartPose.offsetAndRotation(7.0F, -10.0F, 0.0F, 0.0F, 0.0F, 0.7854F));
