...
public class AMSporeParticle extends TextureSheetParticle {
    ...
    protected AMSporeParticle(ClientLevel clientLevel, double x, double y, double z, double xVelocity, double yVelocity, double zVelocity, SpriteSet spriteSet) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(@NotNull SimpleParticleType type, @NotNull ClientLevel level, double x, double y, double z, double xVelocity, double yVelocity, double zVelocity) {
            return new AMSporeParticle(level, x, y, z, xVelocity, yVelocity, zVelocity, this.sprites);
        }
    }
}
