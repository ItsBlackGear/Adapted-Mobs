...
public class SupportCreeperModel<T extends SupportCreeper> extends AgeableHierarchicalModel<T> {
    ...
    public static LayerDefinition createBodyLayer(CubeDeformation deformation) {
        ...
        PartDefinition leg0 = body.addOrReplaceChild("leg0", CubeListBuilder.create().texOffs(0, 41).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 9.0F, 4.0F, deformation), PartPose.offset(-2.0F, -9.0F, 2.0F));

        PartDefinition leg1 = body.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(17, 41).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 9.0F, 4.0F, deformation), PartPose.offset(2.0F, -9.0F, 2.0F));
        ...
        PartDefinition leg3 = body.addOrReplaceChild("leg3", CubeListBuilder.create().texOffs(17, 28).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 9.0F, 4.0F, deformation), PartPose.offset(2.0F, -9.0F, -2.0F));
